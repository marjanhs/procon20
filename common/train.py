from common.trainers.advn_classification_trainer  import ClassificationTrainer
...
class TrainerFactory(object):
    ...
    trainer_map = {
        ...
        'News': ClassificationTrainer,
        'News_art': ClassificationTrainer,
        'Procon': ClassificationTrainer
    }
