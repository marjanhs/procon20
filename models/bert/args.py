...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='SST-2', choices=['SST-2', 'AGNews', 'Reuters', 'AAPD', 'IMDB',
                                                                         'Yelp2014', 'Personality', 'News_art', 'News',
                                                                         'UCI_yelp', 'Procon','Style', 'ProconDual', 'Pan15',
                                                                         'Pan14E', 'Pan14N', 'Perspectrum'
                                                                         ])
    ...
    parser.add_argument('--do', default='main', type=str, choices=['main', 'analyze', 'transfer', 'classify'])
    parser.add_argument('--analyze-split', default=None, type=str)
